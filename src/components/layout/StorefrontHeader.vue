<template>
  <AppHeader :show-sidebar-toggle="false">
    ...
    <template #bottom>
      <div
        class="bg-surface dark:bg-surface-dark py-4 border-b border-gray-200 dark:border-gray-800 shadow-sm"
      >
        <div
          class="container mx-auto flex items-center justify-center gap-8 flex-wrap lg:flex-nowrap px-4"
        >
          <!-- Logo -->
          ...
          <div class="flex-grow flex flex-col min-w-0 mx-4">
            ...
            >
              ...
              />
              <button
                class="bg-primary hover:bg-primary-dark text-white px-6 py-2 rounded-sm transition-colors"
              >
            ...
            <div
              v-if="false"
              class="flex gap-3 text-xs text-gray-500 dark:text-gray-400 mt-2 px-1"
            >
              <a href="#" class="hover:text-primary transition-colors truncate"
                >iPhone 15</a
              >
              <a href="#" class="hover:text-primary transition-colors truncate"
              ...
              <a
                href="#"
                class="hover:text-primary transition-colors truncate lg:inline-block hidden"
                >Túi xách nữ</a
              >
            </div>
          </div>
